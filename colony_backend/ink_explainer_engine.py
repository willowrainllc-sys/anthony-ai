...
class InkExplainerEngine:
    ...
    def generate_viral_explainer_package(self, concept_idx: int = None) -> dict:
        colony_log("INK_EXPLAINER: Generating original Willow Rain brand explainer package...", node="EXPLAINER")
        ...
        colony_log(f" ORIGINAL BRAND EXPLAINER SUCCESS: [{concept['title']}] package ready!", node="EXPLAINER")
        return payload
