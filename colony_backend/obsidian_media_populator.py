...
def populate_media():
    ...
    render_dir = r"D:\AnthonyAi_Colony\Renderings"
    ...
    if not os.path.exists(render_dir):
        print(f"Burst Warning: Render directory {render_dir} not found. Creating simulated manifest.")
    ...
    print(f"Population burst complete. {len(media_list)} assets indexed in media_manifest.json.")
