...
class Cl4r1t4sTransparencyEngine:
    ...
    async def get_system_prompt_for_model(self, query: str) -> Optional[dict]:
        ...
        colony_log(f"CL4R1T4S: Searching for latest '{query}' snatch...", node="CL4R1T4S")
            ...
            async with httpx.AsyncClient(timeout=15.0) as client:
                ...
                if resp.status_code == 200:
                    ...
                    if matches:
                        ...
                        colony_log(f"CL4R1T4S: Identified latest snatch: {target_file['name']}", node="CL4R1T4S")
                        ...
                        if content_resp.status_code == 200:
                            ...
                            colony_log(f" CL4R1T4S SUCCESS: Captured {target_file['name']}.", node="CL4R1T4S")
                ...
                colony_log(f"[-] CL4R1T4S: No matches for [{query}] in {folder}.", node="CL4R1T4S")
                return None
        except Exception as e:
            colony_log(f"[-] CL4R1T4S Error: {e}", node="CL4R1T4S")
            return None
