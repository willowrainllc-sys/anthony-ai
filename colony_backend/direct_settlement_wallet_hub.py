...
class DirectSettlementWalletHub:
    ...
    async def record_direct_stablecoin_settlement(self, source_entity: str, amount_usd: float, network: str = "POLYGON") -> DirectSettlementRecord:
        ...
        colony_log(f"SETTLEMENT_HUB: Incoming direct {network} USDC settlement (${amount_usd:.2f}) from [{source_entity}]...", node="SETTLEMENT_HUB")
        ...
        colony_log(f" SETTLEMENT_HUB SUCCESS: Proposal Sent ${amount_usd:.2f} USDC & Synced to Square Bank Account!", node="SETTLEMENT_HUB")
        return record
    ...
    async def record_corporate_wire_settlement(self, corporate_buyer: str, amount_usd: float) -> DirectSettlementRecord:
        ...
        colony_log(f"SETTLEMENT_HUB: Incoming B2B Corporate Wire (${amount_usd:.2f}) from [{corporate_buyer}]...", node="SETTLEMENT_HUB")
        ...
        colony_log(f" SETTLEMENT_HUB SUCCESS: Proposal Sent ${amount_usd:.2f} B2B Wire & Synced to Square Bank Account!", node="SETTLEMENT_HUB")
        return record
