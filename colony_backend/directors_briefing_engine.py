...
class DirectorsBriefingEngine:
    ...
    def generate_briefing(self) -> str:
        colony_log("BRIEFING: Compiling the Director's daily intelligence report...", node="BRIEFING")
        ...
        summary += "2. REVENUE BURSTS (LAST PULSE):\n"
        for evt, meta_str in revenue_events:
            if "REWARD_CLAIMED" in evt or "BURST_SUCCESS" in evt:
