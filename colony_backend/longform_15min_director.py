...
class Longform15MinDirector:
    ...
    def generate_random_15min_documentary(self, archive_idx: int = None) -> Longform15MinStoryPlan:
        ...
        colony_log(f"DIRECTOR: Architecting 9-Minute Documentary [{doc['title']}]...", node="LONGFORM_DIRECTOR")
        ...
        colony_log(f" 9MIN_DIRECTOR SUCCESS: Created Standalone Documentary [{doc['title']}] ({total_words} words)!", node="LONGFORM_DIRECTOR")
        return plan
