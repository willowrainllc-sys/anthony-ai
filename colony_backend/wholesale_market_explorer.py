...
class WholesaleMarketExplorer:
    ...
    def register_new_opportunity(self, opp: WholesaleOpportunity):
        ...
        colony_log(f" MARKET_EXPLORER: Registered new wholesale opportunity: {opp.name}", node="EXPLORER")

    def generate_market_report(self) -> str:
        colony_log("MARKET_EXPLORER: Compiling Untapped Wholesale Market Report...", node="EXPLORER")
        ...
        colony_log(f" MARKET_EXPLORER SUCCESS: Report generated. Total Scaling Capacity: ${total_yield:,.2f}/mo.", node="EXPLORER")
