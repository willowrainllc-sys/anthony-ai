...
class BandwidthCenterClusterManager:
    ...
    async def execute_cluster_bandwidth_run(self) -> dict:
        colony_log("BANDWIDTH_CLUSTERS: Aggregating traffic across 5 Regional Bandwidth Centers (20 subnets)...", node="BW_CLUSTERS")
        ...
        colony_log(f" BANDWIDTH_CLUSTERS SUCCESS: Routed {total_gb_routed} GB -> Earned ${total_earned_usd} USD deposited to Square!", node="BW_CLUSTERS")
