...
class AresSupremeOrchestrator:
    ...
    def __init__(self):
        ...
        self.models = {
            "reasoning": "anthropic/claude-3.5-sonnet", # The "Logic" Master
            "coding": "anthropic/claude-3.5-sonnet",    # The "Architect"
            "vision": "google/gemini-pro-1.5-vision",   # The "Eyes"
            "fast": "google/gemini-flash-1.5",          # The "Nerve"
            "private": "Anthony-Supreme-v29"            # The "Director's" Local
        }
