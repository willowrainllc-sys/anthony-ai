...
class EarnAppBrowserBot:
    ...
    async def run_earnapp_check(self, headless: bool = True) -> dict:
        colony_log("EARNAPP_BOT: Initializing EarnApp Headless Session...", node="EARNAPP_BOT")
        try:
            ...
            async with async_playwright() as p:
                ...
                colony_log("EARNAPP_BOT: Navigating to EarnApp dashboard...", node="EARNAPP_BOT")
                ...
                colony_log(f" EARNAPP_BOT: Connected to portal [{title}]", node="EARNAPP_BOT")
            ...
            colony_log(f"[-] EARNAPP_BOT ERROR: {e}", node="EARNAPP_BOT")
            return {
                "status": "ERROR",
                "message": str(e)
            }
