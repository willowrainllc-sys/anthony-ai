...
<body>
    ...
    <div class="editor-container">
        ...
        <div class="toolbar">
            ...
            <button onclick="triggerBurst()" style="background: #8B5CF6; color: #FFF;">TRIGGER BURST</button>
...
async def get_tree():
    ...
    files = []
    backend_path = ROOT_DIR / "colony_backend"
...
async def read_file(path: str):
    full_path = ROOT_DIR / "colony_backend" / path
...
async def write_file(data: dict):
    ...
    colony_log(f"IDE: Sovereign write complete for [{path}].", node="IDE")
