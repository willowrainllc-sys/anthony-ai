...
class ObsidianCpuHarvester:
    ...
    async def execute_mining_pulse(self, duration_hrs: float = 1.0) -> MinerStatus:
        colony_log("CPU_HARVESTER: Executing CPU mining pulse across node grid...", node="MINER")
        ...
        colony_log(f" MINER SUCCESS: Stacked {earned:.4f} Satoshis. Total Yield: Pennies.", node="MINER")
        return status
