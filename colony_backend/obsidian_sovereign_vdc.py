...
BACKEND_DIR = ROOT_DIR / "colony_backend"
...
class ObsidianSovereignVDC:
    ...
    async def ignite_sovereign_cloud(self):
        colony_log("[SUPREME] VDC: Initiating Migration from 3rd Party to OBSIDIAN SOVEREIGN CLOB...", node="SUPREME")
        ...
        colony_log(f" [SUCCESS] VDC: Obsidian Sovereign Cloud is ACTIVE. We are the host.", node="SUPREME")
    ...
    async def _ignite_hypervisor(self):
        ...
        colony_log(f"VDC: Hypervisor active. Managing {self.total_compute_ghz:.1f}GHz of Obsidian Power.", node="SUPREME")
