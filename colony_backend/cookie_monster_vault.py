...
class CookieMonsterVault:
    ...
    def eat_and_vault_session(self, portal_id: str, storage_state: dict) -> str:
        ...
        try:
            ...
            colony_log(f" COOKIE MONSTER: Ate & vaulted {cookies_count} session cookies for [{portal_id.upper()}]!", node="COOKIE_MONSTER")
            ...
            colony_log(f"[-] Cookie Monster Error: {e}", node="COOKIE_MONSTER")
            return None
    ...
    def sweep_and_eat_all_local_cookies(self) -> int:
        ...
        colony_log(" COOKIE MONSTER: Sweeping local vault for fresh session cookies...", node="COOKIE_MONSTER")
        ...
        colony_log(f" COOKIE MONSTER: Sweep complete. Vaulted {eaten_count} session files.", node="COOKIE_MONSTER")
        return eaten_count
