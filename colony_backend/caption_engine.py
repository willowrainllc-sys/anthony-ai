...
class CaptionEngine:
    ...
    async def generate_mobile_captions(self, audio_path: str):
        colony_log("CAPTIONS: Transcribing narrative for mobile optimization...", node="CAPTIONS")
...
[V4+ Styles]
Format: Name, Fontname, Fontsize, PrimaryColour, SecondaryColour, OutlineColour, BackColour, Bold, Italic, Underline, BurstOut, ScaleX, ScaleY, Spacing, Angle, BorderStyle, Outline, Shadow, Alignment, MarginL, MarginR, MarginV, Encoding
