...
class BandwidthDataHubManager:
    ...
    async def rent_bandwidth_space_to_company(self, company_name: str, plan_type: str = "starter") -> CompanySpaceAccess:
        ...
        colony_log(f"BANDWIDTH_HUB: Renting [{space['name']}] to company [{company_name}] for ${price}/mo...", node="BW_HUB")
        ...
        colony_log(f" BANDWIDTH_HUB SUCCESS: Space [{space['space_id']}] rented to {company_name} (${price}/mo)!", node="BW_HUB")
        return access_obj
