...
async def bind_wallet():
    ...
    async with async_playwright() as p:
        try:
            # We use headful for this one burst to ensure we see the result
            ...
            await page.screenshot(path="D:\\ObsidianAi_Colony\\Temp\\wallet_bind_check.png")
            ...
            if BTC_WALLET in content:
                ...
                print("    Action: Execute 'python colony_backend/disciple_login_portal.py OBSIDIAN_BRIDGE' and click 'Connect Wallet'.")
