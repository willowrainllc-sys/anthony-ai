...
class NvidiaPairRouter:
    ...
    async def route_narrative_prompt(self, prompt: str, system_msg: str = "", model_tier: str = "nim_70b") -> str:
        colony_log(f"NVIDIA PAIR: Routing prompt via hardware-accelerated NIM [{model_tier}]...", node="PAIR")
            ...
            try:
                ...
                async with httpx.AsyncClient(timeout=45.0) as client:
                    ...
                    if resp.status_code == 200:
                        ...
                        colony_log(" NVIDIA PAIR: Hardware-accelerated response received.", node="PAIR")
                        return content
            except Exception as e:
                colony_log(f"[-] NVIDIA PAIR Exception: {e}", node="PAIR")
        ...
        try:
            ...
            colony_log(f"PAIR Fallback Note: {e}", node="PAIR")
