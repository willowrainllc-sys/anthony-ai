...
class AlwaysOnAutopilotManager:
    ...
    async def execute_always_on_cycle(self) -> AlwaysOnPipelineStatus:
        ...
        colony_log("ALWAYS_ON_MANAGER: Triggering Self-Healing AI loop for Social Hubs & Data Brokers...", node="ALWAYS_ON")
        try:
        ...
        colony_log(f" ALWAYS_ON SUCCESS: Pipeline [{pipeline_id}] running 24/7! Health: {health_score}% | Processed: {status_obj.total_gb_processed_24h} GB", node="ALWAYS_ON")
        return status_obj
