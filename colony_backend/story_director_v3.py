...
class NicheDirectorV3:
    ...
    def generate_director_blueprint(self, forced_topic: str = None) -> ProductionBlueprint:
        ...
        colony_log(f"DIRECTOR_V3: Directing 3-minute anomaly deep-dive for [{topic[:35]}...]...", node="DIRECTOR_V3")
        ...
        colony_log(f" DIRECTOR_V3 SUCCESS: Created 3-Minute Production Blueprint [{title}]!", node="DIRECTOR_V3")
        return blueprint
