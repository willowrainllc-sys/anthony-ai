...
class IpsosBrowserBot:
    ...
    async def run_ipsos_survey_check(self, headless: bool = True) -> dict:
        colony_log("IPSOS_BOT: Initializing Ipsos i-Say Headless Session with Human Stealth...", node="IPSOS_BOT")
        try:
            ...
            async with async_playwright() as p:
                ...
                colony_log("IPSOS_BOT: Navigating to Ipsos i-Say portal...", node="IPSOS_BOT")
                ...
                colony_log(f" IPSOS_BOT: Connected to portal [{title}]", node="IPSOS_BOT")
            ...
            colony_log(f"[-] IPSOS_BOT ERROR: {e}", node="IPSOS_BOT")
            return {
                "status": "ERROR",
                "message": str(e)
            }
