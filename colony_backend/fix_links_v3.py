...
# --- GLOBAL LINK REPAIR v3.0 (Android & Local Server Perfect) ---
import os
        ...
        for hf in d.rglob("*.html"):
            ...
            try:
                ...
                for old, new in mappings.items():
                    # Replace absolute clean URLs with relative HTML files
                    targets = [f'href="{old}"', f"href='{old}'", f'href="{old}/"', f"href='{old}/'"]
