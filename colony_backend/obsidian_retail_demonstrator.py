...
class ObsidianRetailDemonstrator:
    ...
    async def run_demonstration(self):
        colony_log(" RETAIL: Initiating front-end work for Amazon and Printful...", node="MEDIA")
        ...
        async with async_playwright() as p:
            ...
            # 1. Amazon Burst
            try:
                colony_log(" RETAIL: Bot is physically auditing Amazon Seller Central...", node="MEDIA")
            ...
            # 2. Printful Burst
            try:
                colony_log(" RETAIL: Bot is physically designing products in Printful...", node="MEDIA")
            ...
            await browser.close()
            colony_log(" RETAIL SUCCESS: Front-end pulse complete. Images pushed to Dashboard.", node="MEDIA")
