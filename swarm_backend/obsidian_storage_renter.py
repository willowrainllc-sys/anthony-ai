...
class ObsidianStorageRenter:
    ...
    async def execute_storage_yield_audit(self) -> float:
        swarm_log("STORAGE_MGR: Auditing distributed storage nodes...", node="STORAGE_MGR")
        ...
        swarm_log(f" STORAGE_MGR SUCCESS: Storage Active. Monthly Yield: ${total_monthly:,.2f} USD.", node="STORAGE_MGR")
