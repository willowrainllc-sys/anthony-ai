...
class SaturnPoisonPill:
    ...
    def __init__(self):
        ...
        self.vault_dir = Path(r"C:\AnthonyAi_Swarm")

    def execute_poison_pill(self, reason="BREACH_DETECTED"):
        swarm_log(f"[DEATH] POISON_PILL: INITIATING SELF-DESTRUCT. Reason: {reason}", node="SECURITY")
        ...
        if self.vault_dir.exists():
            swarm_log("[DEATH] POISON_PILL: Shredding Empire Vault...", node="SECURITY")
        ...
        swarm_log("[SUPREME] POISON_PILL SUCCESS: Life signs erased. The system is GHOST.", node="SECURITY")
