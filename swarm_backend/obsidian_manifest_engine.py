...
class ObsidianArchitecture(BaseModel):
    ...
    central_brain: str = "v4.0 (swarm_brain.py)"
...
class ObsidianManifestEngine:
    ...
    def generate_master_manifest(self) -> ObsidianSystemManifest:
        swarm_log("OBSIDIAN: Compiling Master System Manifest & Key Vault...", node="OBSIDIAN")
        ...
        swarm_log(f" OBSIDIAN SUCCESS: Master Manifest [{manifest.manifest_id}] Locked & Loaded for Central Brain!", node="OBSIDIAN")
        return manifest
