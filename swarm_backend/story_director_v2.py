...
GENRE_ARCHETYPES = {
    ...
    "natgeo_nature": {
        ...
        "narration_s3": "Swarming the mineral vents were thousands of unclassified organisms pulsing in rhythmic bioluminescent light patterns.",
...
class StoryDirectorOrchestrator:
    ...
    def generate_production_story_plan(self, user_idea: str, genre: str = "exoplanets") -> StoryPlan:
        swarm_log(f"STORY_DIRECTOR_V2: Directing [{genre.upper()}] story plan for [{user_idea[:30]}]...", node="DIRECTOR_V2")
        ...
        swarm_log(f" DIRECTOR_V2 SUCCESS: Validated [{genre.upper()}] Story Plan [{story_plan.title}]!", node="DIRECTOR_V2")
        return story_plan
