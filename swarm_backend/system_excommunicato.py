...
class SystemExcommunicato:
    ...
    def execute_purge(self):
        swarm_log("EXCOMMUNICATO: Initiating system-wide purge of unauthorized loops...", node="SECURITY")
        ...
        swarm_log(f"✓ EXCOMMUNICATO SUCCESS: {killed_count} external loops terminated. System isolated.", node="SECURITY")
        return killed_count
