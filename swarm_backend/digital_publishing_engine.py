...
class DigitalPublishingEngine:
    ...
    async def generate_catchy_ebook(self, category_key: str = "cozy_girl_bold_easy", price_usd: float = 14.99) -> dict:
        ...
        swarm_log(f"PUBLISHING: Synthesizing Elite Color E-Book [{full_title}]...", node="EBOOK")
        ...
        swarm_log(f" EBOOK SUCCESS: [{full_title}] is live! Size: {pdf_path.stat().st_size} bytes", node="EBOOK")
        return {
            "status": "success",
            "title": full_title,
