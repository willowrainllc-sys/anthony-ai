...
class ObsidianNodeTracker:
    ...
    """
    def __init__(self):
        self.registry_path = Path(r"D:\ObsidianAi_Swarm\Secure_Assets\node_registry.json")

    async def audit_grid_performance(self) -> dict:
        swarm_log("TRACKER: Executing grid-wide capital performance audit...", node="FINANCE")
        ...
        swarm_log(f" TRACKER SUCCESS: Grid is generating ${total_daily_yield:,.2f} / day.", node="FINANCE")
        return audit_result
