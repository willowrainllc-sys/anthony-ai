...
class ObsidianSessionGuardian:
    ...
    async def run_guardian_loop(self):
        swarm_log(" GUARDIAN: Initiating Identity Protection Loop...", node="SECURITY")
        ...
        while self.is_active:
            try:
                ...
                swarm_log(" GUARDIAN: 103 user identities verified. No breaches detected.", node="SECURITY")
                ...
                swarm_log(f"[-] GUARDIAN ERROR: {e}", node="SECURITY")
