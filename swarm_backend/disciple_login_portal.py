...
class DiscipleLoginPortal:
    ...
    async def open_interactive_login(self, portal_id: str):
        ...
        swarm_log(f"LOGIN_PORTAL: Opening interactive session for [{portal_id}]...", node="SECURITY")
        ...
        async with async_playwright() as p:
            ...
            swarm_log(f" LOGIN_PORTAL: Session for [{portal_id}] successfully vaulted.", node="SECURITY")
            await browser.close()
