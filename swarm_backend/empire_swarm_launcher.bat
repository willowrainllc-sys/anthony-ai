...
cd /d "C:\Users\willo\OneDrive\Desktop\Obsidian_Ai\swarm_backend"
...
start "Video Swarm Pipeline" cmd /k "title Video Swarm Pipeline && C:\Users\willo\OneDrive\Desktop\Obsidian_Ai\venv\Scripts\python.exe master_pipeline.py"
