...
JUNK_SCRIPTS = [
    ...
    "populate_store.py",
    "wipe_store.py",
    "store_sales_striker.py",
    "viking_context_engine.py",
    "viking_context_engine.py",
    "demonstrate_team_chat.py",
    "manual_amigos_strike.py",
    "manual_feed_strike.py",
...
TEMP_FOLDERS = [
    Path(r"D:\ObsidianAi_Swarm\Secure_Assets\renderings"),
...
def execute_obsidian_purge():
    ...
    backend_dir = Path(r"C:\Users\willo\OneDrive\Desktop\Obsidian_Ai\swarm_backend")
    purged_count = 0
    ...
    logs_dir = Path(r"D:\ObsidianAi_Swarm\Logs")
    if logs_dir.exists():
