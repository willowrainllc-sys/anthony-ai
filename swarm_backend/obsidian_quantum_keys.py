...
class ObsidianQuantumKeys:
    ...
    def generate_pqc_session_key(self, session_id: str) -> dict:
        swarm_log(f"QUANTUM_KEYS: Generating high-entropy PQC session key for [{session_id}]...", node="SECURITY")
        ...
        swarm_log(f" QUANTUM_KEYS SUCCESS: Grid session [{session_id}] is now PQC-Shielded.", node="SECURITY")
        return key_pair
