...
class ObsidianKickbackEngine:
    ...
    async def run_kickback_loop(self):
        swarm_log("[TITAN] KICKBACK: Initiating Thinking-to-Revenue filter...", node="MEDIA")
        ...
        while self.is_active:
            try:
                ...
                swarm_log(f"✓ KICKBACK: Filtered and Dispatched -> {kickback_msg[:60]}...", node="MEDIA")
                ...
                swarm_log(f"[-] KICKBACK ERROR: {e}", node="MEDIA")
