...
function initObsidianAIChat() {
    ...
    win.innerHTML = `
        ...
        <div class="chat-body" id="obsidian_aiChatBody">
            <div class="msg msg-obsidian_ai">Greetings. I am Obsidian AI, your AI Digital Intelligence (AI). ARES directs the AI. What is your objective? your business growth today?</div>
        </div>
